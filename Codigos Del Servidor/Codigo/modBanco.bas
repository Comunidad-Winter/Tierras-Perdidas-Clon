...
Sub SendBanObj(UserIndex As Integer, Slot As Byte, Object As UserOBJ)
    ...
    If Object.ObjIndex > 0 Then
        ...
        Call SendData(SendTarget.ToIndex, UserIndex, 0, "SBO" & Slot & "," & Object.ObjIndex & "," & ObjData(Object.ObjIndex).name & "," & Object.Amount & "," & ObjData(Object.ObjIndex).GrhIndex & "," & ObjData(Object.ObjIndex).OBJType & "," & ObjData(Object.ObjIndex).MaxHIT & "," & ObjData(Object.ObjIndex).MinHIT & "," & ObjData(Object.ObjIndex).MaxDef)
...
Sub UserRetiraItem(ByVal UserIndex As Integer, _
    ...
    If UserList(UserIndex).BancoInvent.Object(i).Amount > 0 Then
        ...
        Call UpdateVentanaBanco(CInt(i), 0, UserIndex)
    End If
...
Sub UserDepositaItem(ByVal UserIndex As Integer, _
    ...
    If UserList(UserIndex).Invent.Object(Item).Amount > 0 And UserList(UserIndex).Invent.Object(Item).Equipped = 0 Then
        ...
        Call UpdateVentanaBanco(CInt(Item), 1, UserIndex)
