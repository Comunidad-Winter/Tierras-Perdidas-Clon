   ...
   If UserIndex > 0 Then ' Lo mato un usuario?
        ...
        If MiNPC.flags.ExpCount > 0 Then
            ...
            Else
                ...
                Call SendData(SendTarget.ToIndex, UserIndex, 0, "||Has ganado " & MiNPC.flags.ExpCount & " puntos de experiencia." & FONTTYPE_DAREXP)
            End If
...
On Error GoTo errhandler
    ...
    If InMapBounds(Npclist(NpcIndex).Pos.X, Npclist(NpcIndex).Pos.Y) Then
