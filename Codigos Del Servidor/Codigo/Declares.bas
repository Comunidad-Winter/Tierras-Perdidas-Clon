...
'************ Kshameenk Item Scrolling ************
Public ObjSlot1 As Byte
Public ObjSlot2 As Byte
Rem CVC
    Public UsuariosEnCvcClan1    As Long, UsuariosEnCvcClan2 As Long
    Public Liderr      As Integer
    Public C1, C2      As Integer
    Public NameClan1, NameClan2 As String
    Public IndexClan1, IndexClan2 As Integer
    Public HayCvc      As Boolean
...
Public Type Torneo
    ...
    Y As String
End Type
Public juanete(1 To 64) As String
Public contador As Long
Public Torne As Torneo
Public CuentaTorneo As Integer
Public CuentaUsuario As Integer
'/FISHAR.-
'Global
...
Public Const LimiteNewbie As Byte = 10
...
Public Const FONTTYPE_AZULC As String = "~0~0~255~0~1"
...
Public Type UserStats
    DonoSms As Integer
    DonoBoleta As Integer
    Honor As Long
    PuntosDeTorneo As Integer
    GLD As Long 'Dinero
    Banco As Long
    MET As Integer
...
End Type
'declaraciones sistema de retos
        Public nickReto As String
        Public PuntosReto As String
        Public FragsReto As String
        Public ItemReto As String
        Public QueOBJSeReta As Obj
'declaraciones sistema de retos
'declaraciones sistema de duelos
   Public dMap        As Byte
...
Public Type UserFlags
    UltimoenMandarReto As String
    LeMandanReto As Boolean
    enDesafio As Boolean
    EnPareja As Boolean
    EstoyEnTorneo As Boolean
    EnCvc As Boolean
