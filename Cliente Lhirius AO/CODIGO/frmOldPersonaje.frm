...
NameTxt.Text = ""
PasswordTxt.Text = ""
Me.Picture = LoadPicture(App.path & "\Graficos\Principal\oldcaracter.jpg")
Image1(1).Picture = LoadPicture(App.path & "\Graficos\Principal\bvolver.jpg")
Image1(0).Picture = LoadPicture(App.path & "\Graficos\Principal\bsiguiente.jpg")
Image1(2).Picture = LoadPicture(App.path & "\Graficos\Principal\bteclas.jpg")
...
Select Case index
    Case 0
        If Image1(0).Tag = "0" Then
            ...
            Image1(0).Picture = LoadPicture(App.path & "\Graficos\Principal\bsiguientea.jpg")
        End If
    Case 1
        If Image1(1).Tag = "0" Then
            ...
            Image1(1).Tag = "1"
            Call Audio.PlayWave(SND_OVER)
            Image1(1).Picture = LoadPicture(App.path & "\Graficos\Principal\bvolvera.jpg")
        End If
    Case 2
        If Image1(2).Tag = "0" Then
            ...
            Image1(2).Tag = "1"
            Call Audio.PlayWave(SND_OVER)
            Image1(2).Picture = LoadPicture(App.path & "\Graficos\Principal\bteclasa.jpg")
        End If
