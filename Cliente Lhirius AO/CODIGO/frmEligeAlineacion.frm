...
Begin VB.Form frmEligeAlineacion 
   ...
   ClientWidth     =   6705
   ControlBox      =   0   'False
   Icon            =   "frmEligeAlineacion.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5250
   ...
   Begin VB.Label lblDescripcion 
      ...
      Caption         =   $"frmEligeAlineacion.frx":000C
      ForeColor       =   &H00FFFFFF&
      Height          =   645
      Index           =   4
      Left            =   1095
   ...
   Begin VB.Label lblDescripcion 
      BackColor       =   &H00000080&
      BackStyle       =   0  'Transparent
      Caption         =   $"frmEligeAlineacion.frx":00E1
      ForeColor       =   &H00FFFFFF&
      Height          =   645
      Index           =   3
      Left            =   1095
   ...
   Begin VB.Label lblDescripcion 
      BackColor       =   &H00400040&
      BackStyle       =   0  'Transparent
      Caption         =   $"frmEligeAlineacion.frx":01BD
      ForeColor       =   &H00FFFFFF&
      Height          =   645
      Index           =   2
      Left            =   1095
   ...
   Begin VB.Label lblDescripcion 
      BackColor       =   &H00800000&
      BackStyle       =   0  'Transparent
      Caption         =   $"frmEligeAlineacion.frx":0269
      ForeColor       =   &H00FFFFFF&
      Height          =   645
      Index           =   1
      Left            =   1095
   ...
   Begin VB.Label lblDescripcion 
      BackColor       =   &H00400000&
      BackStyle       =   0  'Transparent
      Caption         =   $"frmEligeAlineacion.frx":0332
      ForeColor       =   &H00FFFFFF&
      Height          =   825
      Index           =   0
      Left            =   1095
