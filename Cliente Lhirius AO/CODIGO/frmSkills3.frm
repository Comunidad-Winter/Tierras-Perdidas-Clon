...
Image1.Picture = LoadPicture(App.path & "\Graficos\Principal\SkillsOkNoApretado.jpg")
...
For I = 0 To NUMSKILLS * 2 - 1
    If I Mod 2 = 0 Then
        'Command1(i).Picture = LoadPicture(App.path & "\Graficos\Principal\BotónMás.jpg")
    Else
        'Command1(i).Picture = LoadPicture(App.path & "\Graficos\Principal\BotónMenos.jpg")
    End If
Next
