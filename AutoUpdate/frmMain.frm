...
Call ShellExecute(Me.hWnd, "open", App.Path & "/TPAO-CLON.exe", "", "", 1)
...
Private Sub Inet1_StateChanged(ByVal State As Integer)
    Select Case State
        Case icError
            Call addConsole("Error en la coneccion, descarga abortada.", 255, 0, 0, True, False)
            bDone = True
            dError = True
